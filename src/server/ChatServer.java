...
public class ChatServer extends UnicastRemoteObject implements ChatServerIF
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            System.out.println("Servidor de Grupo de chat RMI esta corriendo...");
        }
        catch(Exception e)
        {
            System.out.println("El servidor ha tenido problemas para iniciar");
	}
    }
    ...
    *-----------------------------------------------------------*/
    ...
    public String sayHello(String ClientName) throws RemoteException
    {
        ...
        return "Hola " + ClientName + " del grupo del servidor de chat";
    }
    ...
    public void registerListener(String[] details) throws RemoteException
    {
        ...
        System.out.println(details[0] + " ha iniciado la sesion de chat");
    ...
    private void registerChatter(String[] details)
    {
        try
        {
            ...
            nextClient.messageFromServer("[Servidor] : Hola " + details[0] + " ahora puedes chatear.\n");
            sendToAll("[Servidor] : " + details[0] + " se ha unido al grupo.\n");
            updateUserList();
        }
    ...
    public void leaveChat(String userName) throws RemoteException
    {
        for(Chatter c : chatters)
        {
            ...
            {
                System.out.println(line + userName + " abandonó la sesión de chat");
                System.out.println(new Date(System.currentTimeMillis()));
                chatters.remove(c);
                break;
            }

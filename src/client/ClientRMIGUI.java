...
public class ClientRMIGUI extends JFrame implements ActionListener
{
    ...
    private final Font meiryoFont = new Font("Times New Roman", Font.PLAIN, 14);
    ...
    public ClientRMIGUI()
    {
        frame = new JFrame("Consola de chat de cliente");
        //-----------------------------------------
        /*
        ...
        frame.addWindowListener(new java.awt.event.WindowAdapter()
        {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent)
            {
                if(chatClient != null)
                {
                    try
                    {
                        sendMessage("Adios a todos, Me tengo que retirar");
    ...
    {
        String welcome = "Bienvenido al chat, ingresa tu nombre de usuario y presiona Iniciar para iniciar la conversación\n";
	...
	textPanel.setFont(new Font("Times New Roman", Font.PLAIN, 14));
	return textPanel;
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if(e.getSource() == startButton)
            {
                ...
                if(name.length() != 0)
                {
                    frame.setTitle("Ventana de chat de " + name);
                    textField.setText("");
                    textArea.append("usuario : " + name + " intentando conectarse al chat...\n");
                    getConnected(name);
                ...
                {
                    JOptionPane.showMessageDialog(frame, "Ingresa tu usuario para comenzar");
                }
            }
            ...
            if(e.getSource() == privateMsgButton)
            {
                ...
                {
                    System.out.println("Indice seleccionado :" + privateList[i]);
                }
                message = textField.getText();
                textField.setText("");
    ...
    {
        String privateMessage = "[PM desde " + name + "] :" + message + "\n";
